...
//   if your SetNextItemSelectionData() values are m_indices, you can obtain it from ImGuiMultiSelectIO::NavIdItem, otherwise from g.NavLastValidSelectionUserData.
